...
public class FileListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FileListAdapter(Context context, List<FileModel> fileModelList,OnActionCallBack mCallBack) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            ...
            return new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.layout_file_item, parent, false));
        }
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindViewHolder(int position) {
            ...
            if (infoModel.getFileType() == FileType.TYPE_APK) {
                mBinding.tvName.setText(mContext.getString(R.string.app_name_format, infoModel.getName(), infoModel.getVersion()));

            }
            else if(infoModel.getFileType() == FileType.TYPE_VIDEO){
            ...
            mBinding.mainLayout.setOnClickListener(v -> FileUtils.openFile(infoModel.getPath(), mContext));
            ...
            mBinding.edit.setOnClickListener(view -> mCallBack.callBack(infoModel.getPath()));
